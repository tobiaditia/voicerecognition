        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('theory'.'/'.$theory->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-9">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input id="name" type="text" value="{{ $theory->name }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="content" id="content" cols="30" rows="10"
                                            class="@error('content') is-invalid @enderror form-control">{{ $theory->content }}</textarea>
                                        @error('content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-3 border rounded p-2">
                                ...
                                @foreach ($classes as $class)
                                    <div class="form-check" style="margin-top: 0;">
                                        <input {{ $class->id == $theory->class_id ? "checked" : "" }} class="form-check-input" value="{{ $class->id }}" type="radio" name="class_id"
